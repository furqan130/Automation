...
- Name: factories/factories.spec.js >> Factory Detail Page >> Verify Hourly Graph with Current Month Filter
- Location: tests/factories/factories.spec.js:151:3
...
- main:
  ...
  - text: Aftab Textile Factorys · August 2026
  - img
