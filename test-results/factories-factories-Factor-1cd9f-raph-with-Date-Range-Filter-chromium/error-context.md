...
- Name: factories/factories.spec.js >> Factory Detail Page >> Verify Hourly Graph with Date Range Filter
- Location: tests/factories/factories.spec.js:162:3
...
Call log:
  - waiting for getByRole('grid', { name: 'July 2026' }).getByRole('gridcell', { name: '10', exact: true, disabled: false }).first()
...
- generic [active] [ref=e1]:
          ...
          - generic [ref=e140]:
            - generic [ref=e141]:
              ...
              - generic [ref=e147]:
                ...
                - button "July 1st, 2026" [ref=e149] [cursor=pointer]:
                  - img [ref=e150]
                  - text: July 1st, 2026
              - generic [ref=e152]:
  ...
  - alert [ref=e213]: Aftab Textile Factorys · Count | Digital Eye
```
